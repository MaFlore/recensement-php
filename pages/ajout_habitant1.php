<?php 
    ...
    $id_commune = $_SESSION['commune_id'];
    
    try{
        $liste_commune_par_agent =$connexion_bd->query("SELECT * FROM commune WHERE id=$id_commune");
    }
    catch(Exception $e){
        print_r($e);
    }
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Ajout d'un habitant</title>
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ajout d'un habitant</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Ajout d'un habitant</h4>
                    </div>
                </div>
                <form method="POST" action="../models/ajout_habit_bd.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="eamil" name="email" placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="profil" name="profil" placeholder="profil">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="cni">CNI : </label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="cni" name="cni" placeholder="CNI">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="nomUtilisateur">Nom utilisateur : </label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="nomUtilisateur" name="nomUtilisateur" placeholder="Nom utilisateur">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="custom-select col-12" name="commune_id">
                            <?php
                                foreach( $liste_commune_par_agent as $commune ) {
                            ?>
