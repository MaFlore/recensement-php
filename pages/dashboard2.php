<?php
	...
	$nombre_agents = $connexion_bd->prepare('SELECT id FROM agent');
	$nombre_agents->execute();
	$result_agents = $nombre_agents->rowCount();

	$nombre_admins = $connexion_bd->prepare('SELECT nom FROM administrateur');
	$nombre_admins->execute();
	$result_admins = $nombre_admins->rowCount();
			...
			<div class="row">
				...
				<div class="col-xl-6 mb-60">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							<div class="widget-data">
								<div class="h4 mb-0"><?php echo $result_agents; ?></div>
								<span class="micon dw dw-user1"></span><div class="weight-600 font-14">Agents</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-6 mb-60">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							<div class="widget-data">
								<div class="h4 mb-0"><?php echo $result_admins; ?></div>
								<span class="micon dw dw-user"></span><div class="weight-600 font-14">Administrateurs</div>
							</div>
						</div>
					</div>
				</div>
