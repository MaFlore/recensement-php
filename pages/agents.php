<?php 
    ...
    try{
        $liste_agents=$connexion_bd->query("SELECT * FROM agent ");
    }
    catch(Exception $e){
        print_r($e);
    }
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Listes des agents</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-right">
                            <a href="ajout_agent.php" class="btn btn-primary btn-sm scroll-click">Ajouter</a>
                        </div>
                    </div>
                    <table class="table">
                        <thead>
                        ...
                        <?php 
                            $ordre=0;
                            while($agent=$liste_agents->fetch()){
                                $ordre+=1;  
                            ?>
                            <tr>
                                ...
                                ?></td>
                                <td>
                                    <a href="modification_agent.php?id=<?=$agent['id']?>" class="btn btn-warning btn-sm scroll-click"><i class="icon-copy dw dw-edit-1"></i></a>
                                    <a href="../models/suppression_agent_bd.php?id=<?=$agent['id']?>" data-toggle="modal" data-target="#Medium-modal" type="button" class="btn btn-danger btn-sm scroll-click"><i class="icon-copy dw dw-trash"></i></a>
                                    <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myLargeModalLabel">Suppression d'un agent</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Cette action est irréversible</p>
                                                    <p>Vous êtes de vouloir supprimer cet agent</p>
                                                </div>
