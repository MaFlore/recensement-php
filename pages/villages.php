<?php 
    ...
    try{
        $liste_villages=$connexion_bd->query("SELECT * FROM village ");
    }
    catch(Exception $e){
        print_r($e);
    }
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Listes des villages</title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Villages</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Listes des villages</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-right">
                            <a href="ajout_village.php" class="btn btn-primary btn-sm scroll-click">Ajouter</a>
                        </div>
                    </div>
                    <table class="table">
                        <thead>
                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                ?></td>
                                <td>
                                    <a href="modification_village.php?id=<?=$village['id']?>" class="btn btn-warning btn-sm scroll-click"><i class="icon-copy dw dw-edit-1"></i></a>
                                    <a href="../models/suppression_village_bd.php?id=<?=$village['id']?>" data-toggle="modal" data-target="#Medium-modal" type="button" class="btn btn-danger btn-sm scroll-click"><i class="icon-copy dw dw-trash"></i></a>
                                    <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myLargeModalLabel">Suppression d'un village</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Cette action est irréversible</p>
                                                    <p>Vous êtes de vouloir supprimer ce village</p>
                                                </div>
