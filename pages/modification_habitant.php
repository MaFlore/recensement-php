<?php 
    ...
    try{
        ...
        $habitant = $connexion_bd->prepare('SELECT *  FROM habitant WHERE id=:id');
        $habitant->execute([':id'=> $id]);
        $reponse = $habitant->fetch(PDO::FETCH_OBJ);
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Modification d'un habitant</title>
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Modification d'un habitant</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Modification d'un habitant</h4>
                    </div>
                </div>
                <form method="POST" action="../models/modification_habitant_bd.php">
