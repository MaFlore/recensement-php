...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Ajout d'un préfecture</title>
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ajout d'un préfecture</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Ajout d'un préfecture</h4>
                    </div>
                </div>
                <form method="POST" action="../models/ajout_prefecture_bd.php">
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="code">Code : </label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="code" name="code" placeholder="Le code de la préfecture">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="libelle">Libelle : </label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" id="libelle" name="libelle" placeholder="Le libellé de la préfecture">
                        </div>
                    </div>
                    <div class="form-group row">
